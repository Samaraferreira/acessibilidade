...
export const translations = {
  ...
  'pt-BR': {
    ...
    'hero.title': 'Crie Fluxos de Trabalho Poderosos Sem Código',
    'hero.subtitle': 'Conecte seus aplicativos, automatize seu trabalho e otimize seus processos com nosso construtor visual de fluxos.',
    ...
    'features.visualBuilder.desc': 'Interface drag-and-drop para criar fluxos sem escrever código.',
    ...
    'pricing.popular': 'Popular',
    'pricing.features.workflows': 'Até 5 fluxos',
    'pricing.features.unlimited': 'Fluxos ilimitados',
    ...
    'footer.tagline': 'Crie e automatize fluxos de trabalho com facilidade.',
    ...
    'workflow.title': 'FlowCraft',
    'workflow.back': 'Voltar para lista de fluxos',
    ...
    'workflow.list.title': 'FlowCraft',
    'workflow.list.newWorkflow': 'Novo Fluxo',
    'workflow.list.empty.title': 'Nenhum fluxo ainda',
    'workflow.list.empty.desc': 'Crie seu primeiro fluxo para começar',
    'workflow.list.empty.cta': 'Criar Fluxo',
    'workflow.list.nodes': 'Nós',
    'workflow.list.connections': 'Conexões',
    'workflow.list.openWorkflow': 'Abrir Fluxo',
    'workflow.list.deleteConfirm': 'Tem certeza que deseja excluir este fluxo?',
    'workflow.list.delete': 'Excluir',
    'workflow.list.cancel': 'Cancelar',
    'workflow.list.editName': 'Editar nome do fluxo',
    'workflow.list.saveName': 'Salvar nome do fluxo',
    'workflow.list.loading': 'Carregando fluxos...',
    'workflow.list.retry': 'Tentar Novamente',
    'workflow.nodes.schedule.desc': 'Iniciar fluxo em um agendamento',
    'workflow.nodes.webhook.desc': 'Iniciar fluxo via requisição HTTP',
